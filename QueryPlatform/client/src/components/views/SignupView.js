    ...
    <Container maxWidth={"xs"} sx={{ mt: { xs: 2, md: 6 } }}>
      <Stack alignItems="center">
        <Typography variant="h2" color="text.secondary" sx={{ mb: 6 }}>
          <Link to="http://localhost:3000/" color="inherit" underline="none">
            <img src="../linkcampus.png" width="50%" style={{marginLeft:"90px"}}/>
          </Link>
        </Typography>
        ...
        <Typography color="text.secondary">
          Already an account yet? <Link to="/login">Login</Link>
        </Typography>
